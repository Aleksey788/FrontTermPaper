...
export default function Page() {
  ...
  useEffect(() => {
    const loadDays = async () => {
      try
      {
        const response = await axios.get("https://localhost:7239/habits/overeating/plan/plan14");
  ...
  return (
    <div>
        <h1>Страница о том как избавиться от зависимости переедания за 14 дней</h1>
