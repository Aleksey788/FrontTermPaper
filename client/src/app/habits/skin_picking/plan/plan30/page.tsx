...
export default function Page() {
  ...
  useEffect(() => {
    const loadDays = async () => {
      try
      {
        const response = await axios.get("https://localhost:7239/habits/skin_picking/plan/plan30");
  ...
  return (
    <div>
        <h1>Страница о том как избавиться от привычки вырывать кожу за 30 дней</h1>
