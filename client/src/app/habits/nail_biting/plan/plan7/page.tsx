...
export default function Page() {
  ...
  useEffect(() => {
    const loadDays = async () => {
      try
      {
        const response = await axios.get("https://localhost:7239/habits/nail_biting/plan/plan7");
  ...
  return (
    <div>
        <h1>Страница о том как избавиться от зависимости грызть ногти за 7 дней</h1>
