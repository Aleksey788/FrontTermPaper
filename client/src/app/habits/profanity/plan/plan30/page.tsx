...
export default function Page() {
  ...
  useEffect(() => {
    const loadDays = async () => {
      try
      {
        const response = await axios.get("https://localhost:7239/habits/profanity/plan/plan30");
  ...
  return (
    <div>
        <h1>Страница о том как избавиться от зависимости ругаться матом за 30 дней</h1>
